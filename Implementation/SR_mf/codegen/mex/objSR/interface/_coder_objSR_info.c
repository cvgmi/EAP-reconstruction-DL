...
const mxArray *emlrtMexFcnResolvedFunctionsInfo(void)
{
  ...
  emlrtAssign(&nameCaptureInfo, emlrtCreateStructMatrix(119, 1, 0, NULL));
...
static void b_info_helper(const mxArray **info)
{
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[E]/cise/research51/cvgmi_04/jsun/DictLearningRecon/DL_Manifold/DictL_original/SR_mf/objSR.m"),
                "context", 116);
  emlrtAddField(*info, emlrt_marshallOut("trace"), "name", 116);
  emlrtAddField(*info, emlrt_marshallOut("double"), "dominantType", 116);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/matfun/trace.m"), "resolved", 116);
  emlrtAddField(*info, b_emlrt_marshallOut(1363731868U), "fileTimeLo", 116);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/matfun/trace.m"), "context", 117);
  emlrtAddField(*info, emlrt_marshallOut("coder.internal.isBuiltInNumeric"),
                "name", 117);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_scalar_eg.m"), "resolved",
                118);
  emlrtAddField(*info, b_emlrt_marshallOut(1376002288U), "fileTimeLo", 118);
...
/* End of code generation (_coder_objSR_info.c) */
