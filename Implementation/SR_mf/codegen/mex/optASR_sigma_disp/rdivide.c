...
static emlrtRTEInfo bb_emlrtRTEI = { 1, 14, "rdivide",
  "/opt/matlab2014b/toolbox/eml/lib/matlab/ops/rdivide.m" };

static emlrtRSInfo cd_emlrtRSI = { 13, "rdivide",
  "/opt/matlab2014b/toolbox/eml/lib/matlab/ops/rdivide.m" };

static emlrtRSInfo md_emlrtRSI = { 14, "rdivide",
  "/opt/matlab2014b/toolbox/eml/lib/matlab/ops/rdivide.m" };
             ...
             emxArray_real_T *y, emxArray_real_T *z)
{
  ...
  const mxArray *m8;
  char_T cv42[15];
  static const char_T cv43[15] = { 'M', 'A', 'T', 'L', 'A', 'B', ':', 'd', 'i',
    'm', 'a', 'g', 'r', 'e', 'e' };
  ...
  if (p) {
    ...
    emlrtInitCharArrayR2013a(sp, 15, m8, cv42);
    emlrtAssign(&b_y, m8);
    st.site = &cd_emlrtRSI;
    b_st.site = &md_emlrtRSI;
    error(&st, message(&b_st, b_y, &q_emlrtMCI), &r_emlrtMCI);
  }
