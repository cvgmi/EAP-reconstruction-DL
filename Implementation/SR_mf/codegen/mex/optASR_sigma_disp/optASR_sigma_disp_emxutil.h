/*
 * optASR_sigma_disp_emxutil.h
 *
 * Code generation for function 'optASR_sigma_disp_emxutil'
 *
 */

#ifndef __OPTASR_SIGMA_DISP_EMXUTIL_H__
#define __OPTASR_SIGMA_DISP_EMXUTIL_H__
...
/* End of code generation (optASR_sigma_disp_emxutil.h) */
