/*
 * EstimatedX_emxutil.h
 *
 * Code generation for function 'EstimatedX_emxutil'
 *
 */

#ifndef __ESTIMATEDX_EMXUTIL_H__
#define __ESTIMATEDX_EMXUTIL_H__
...
/* End of code generation (EstimatedX_emxutil.h) */
