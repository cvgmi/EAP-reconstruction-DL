            ...
            if (!(a->size[1] == i1)) {
              ...
              if (a->size[1] == 1) {
                ...
                if (i1 == 1) {
                  ...
                  d_st.site = &id_emlrtRSI;
                  e_st.site = &td_emlrtRSI;
                  error(&d_st, b_message(&e_st, c_y, &g_emlrtMCI), &h_emlrtMCI);
                }
              }
            ...
            if (!(a->size[1] == i1)) {
              ...
              if (a->size[1] == 1) {
                ...
                if (i1 == 1) {
                  ...
                  d_st.site = &id_emlrtRSI;
                  e_st.site = &td_emlrtRSI;
                  error(&d_st, b_message(&e_st, e_y, &g_emlrtMCI), &h_emlrtMCI);
                }
              }
            ...
            if ((normu != 0.0) && (inner * inner < 0.99999)) {
              ...
              if (!(b_A->size[1] == b->size[0])) {
                if (((b_A->size[0] == 1) && (b_A->size[1] == 1)) || ((b->size[0]
                  ...
                  d_st.site = &id_emlrtRSI;
                  e_st.site = &td_emlrtRSI;
                  error(&d_st, b_message(&e_st, h_y, &g_emlrtMCI), &h_emlrtMCI);
                }
              }
              ...
              if (!(Lg->size[1] == M->size[0])) {
                if (((Lg->size[0] == 1) && (Lg->size[1] == 1)) || (M->size[0] ==
                  ...
                  d_st.site = &id_emlrtRSI;
                  e_st.site = &td_emlrtRSI;
                  error(&d_st, b_message(&e_st, j_y, &g_emlrtMCI), &h_emlrtMCI);
                }
              }
