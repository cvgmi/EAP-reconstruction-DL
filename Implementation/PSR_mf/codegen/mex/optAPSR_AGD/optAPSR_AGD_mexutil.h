/*
 * optAPSR_AGD_mexutil.h
 *
 * Code generation for function 'optAPSR_AGD_mexutil'
 *
 */

#ifndef __OPTAPSR_AGD_MEXUTIL_H__
#define __OPTAPSR_AGD_MEXUTIL_H__
...
/* End of code generation (optAPSR_AGD_mexutil.h) */
