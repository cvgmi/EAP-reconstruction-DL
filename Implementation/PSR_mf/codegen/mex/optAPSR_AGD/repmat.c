...
static emlrtMCInfo i_emlrtMCI = { 24, 5, "repmat",
  "/opt/matlab2014b/toolbox/eml/lib/matlab/elmat/repmat.m" };
              ...
              emxArray_real_T *b)
{
  ...
  if (b_varargin_1) {
    ...
    *(int32_T *)mxGetData(m5) = MAX_int32_T;
    ...
    error(&b_st, c_message(&c_st, y, b_y, c_y, &j_emlrtMCI), &k_emlrtMCI);
  }
  ...
  if (2.147483647E+9 >= c_varargin_1) {
    ...
    error(&b_st, b_message(&c_st, d_y, &m_emlrtMCI), &n_emlrtMCI);
  }
