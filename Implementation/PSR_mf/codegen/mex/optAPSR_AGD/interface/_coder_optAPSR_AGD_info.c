...
/* Include files */
#include "_coder_optAPSR_AGD_info.h"
...
static void info_helper(const mxArray **info)
{
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[E]/cise/research51/cvgmi_04/jsun/DictLearningRecon/TMI_expts_SR/PSR_mf/optAPSR_AGD.m"),
                "context", 0);
...
mxArray *emlrtMexFcnProperties()
{
  ...
  mxSetFieldByNumber(xEntryPoints, 0, 0, mxCreateString("optAPSR_AGD"));
...
/* End of code generation (_coder_optAPSR_AGD_info.c) */
