/*
 * optAPSR_AGD_emxutil.h
 *
 * Code generation for function 'optAPSR_AGD_emxutil'
 *
 */

#ifndef __OPTAPSR_AGD_EMXUTIL_H__
#define __OPTAPSR_AGD_EMXUTIL_H__
...
/* End of code generation (optAPSR_AGD_emxutil.h) */
