...
#ifndef __OPTAPSR_AGD_H__
#define __OPTAPSR_AGD_H__
...
extern void optAPSR_AGD(const emlrtStack *sp, const emxArray_real_T *X, const
  emxArray_real_T *W, emxArray_real_T *A0, const struct0_T *param, real_T
  obj_old, emxArray_real_T *A, real_T *obj_new);

#endif

/* End of code generation (optAPSR_AGD.h) */
