 ...
 *
 * Code generation for function '_coder_optAPSR_AGD_revBeta_api'
 *
 */
...
static emlrtRTEInfo sb_emlrtRTEI = { 1, 1, "_coder_optAPSR_AGD_revBeta_api", ""
};
...
void optAPSR_AGD_revBeta_api(const mxArray *prhs[5], const mxArray *plhs[3])
{
  emxArray_real_T *X;
  emxArray_real_T *W;
  emxArray_real_T *A0;
  ...
  optAPSR_AGD_revBeta(&st, X, W, A0, &param, obj_old, A, &obj_new);
...
/* End of code generation (_coder_optAPSR_AGD_revBeta_api.c) */
