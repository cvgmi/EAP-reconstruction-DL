...
static emlrtMCInfo r_emlrtMCI = { 53, 5, "reshape",
  "/opt/matlab2014b/toolbox/eml/lib/matlab/elmat/reshape.m" };

static emlrtMCInfo s_emlrtMCI = { 52, 15, "reshape",
  "/opt/matlab2014b/toolbox/eml/lib/matlab/elmat/reshape.m" };

static emlrtMCInfo t_emlrtMCI = { 42, 9, "eml_assert_valid_size_arg",
  "/opt/matlab2014b/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m" };

static emlrtMCInfo u_emlrtMCI = { 41, 19, "eml_assert_valid_size_arg",
  "/opt/matlab2014b/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m" };

static emlrtMCInfo v_emlrtMCI = { 12, 5, "trace",
  "/opt/matlab2014b/toolbox/eml/lib/matlab/matfun/trace.m" };

static emlrtMCInfo w_emlrtMCI = { 11, 15, "trace",
  "/opt/matlab2014b/toolbox/eml/lib/matlab/matfun/trace.m" };
    ...
    for (i = 0; i <= ub_loop; i++) {
      ...
      if (setjmp(emlrtJBEnviron) == 0) {
        ...
        if (nx == sz[0] * sz[1]) {
          ...
          error(&c_st, b_message(&d_st, y, &r_emlrtMCI), &s_emlrtMCI);
        }
        ...
        if (!(M->size[1] == i14)) {
          ...
          if ((M->size[0] == 1) && (M->size[1] == 1)) {
            ...
            if (i14 == 1) {
              ...
              error(&e_st, b_message(&f_st, b_y, &h_emlrtMCI), &i_emlrtMCI);
            }
          }
          ...
          if (guard2) {
            ...
            error(&e_st, b_message(&f_st, c_y, &f_emlrtMCI), &g_emlrtMCI);
          }
        }
        ...
        if (b_C->size[0] == sz[0] * sz[1]) {
          ...
          c_st.site = &md_emlrtRSI;
          d_st.site = &wd_emlrtRSI;
          error(&c_st, b_message(&d_st, d_y, &r_emlrtMCI), &s_emlrtMCI);
        }
        ...
        if (!(a->size[1] == M->size[0])) {
          if (((a->size[0] == 1) && (a->size[1] == 1)) || ((M->size[0] == 1) &&
            ...
            e_st.site = &hd_emlrtRSI;
            f_st.site = &sd_emlrtRSI;
            error(&e_st, b_message(&f_st, e_y, &f_emlrtMCI), &g_emlrtMCI);
          } else {
            emlrtAssertMATLABThread(&c_st, &c_emlrtRTEI);
            f_y = NULL;
            ...
            e_st.site = &id_emlrtRSI;
            f_st.site = &td_emlrtRSI;
            error(&e_st, b_message(&f_st, f_y, &h_emlrtMCI), &i_emlrtMCI);
          }
        }
        ...
        if (overflow) {
          ...
          error(&c_st, b_message(&d_st, g_y, &v_emlrtMCI), &w_emlrtMCI);
        }
