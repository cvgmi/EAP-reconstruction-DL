               ...
               emxArray_real_T *Y, emxArray_real_T *V)
{
  ...
  if (!(normU->size[1] == Y->size[0])) {
    if ((normU->size[1] == 1) || ((Y->size[0] == 1) && (Y->size[1] == 1))) {
      ...
      error(&c_st, b_message(&d_st, y, &f_emlrtMCI), &g_emlrtMCI);
    } else {
      ...
      error(&c_st, b_message(&d_st, b_y, &h_emlrtMCI), &i_emlrtMCI);
    }
  }
  ...
  if (!(a->size[1] == b->size[0])) {
    if (((a->size[0] == 1) && (a->size[1] == 1)) || ((b->size[0] == 1) &&
      ...
      c_st.site = &hd_emlrtRSI;
      d_st.site = &sd_emlrtRSI;
      error(&c_st, b_message(&d_st, c_y, &f_emlrtMCI), &g_emlrtMCI);
    } else {
      emlrtAssertMATLABThread(&b_st, &c_emlrtRTEI);
      d_y = NULL;
      ...
      c_st.site = &id_emlrtRSI;
      d_st.site = &td_emlrtRSI;
      error(&c_st, b_message(&d_st, d_y, &h_emlrtMCI), &i_emlrtMCI);
    }
  }
  ...
  if (!(U->size[1] == b->size[0])) {
    if (((U->size[0] == 1) && (U->size[1] == 1)) || ((b->size[0] == 1) &&
      ...
      c_st.site = &hd_emlrtRSI;
      d_st.site = &sd_emlrtRSI;
      error(&c_st, b_message(&d_st, e_y, &f_emlrtMCI), &g_emlrtMCI);
    } else {
      emlrtAssertMATLABThread(&b_st, &c_emlrtRTEI);
      f_y = NULL;
      ...
      c_st.site = &id_emlrtRSI;
      d_st.site = &td_emlrtRSI;
      error(&c_st, b_message(&d_st, f_y, &h_emlrtMCI), &i_emlrtMCI);
    }
  }
