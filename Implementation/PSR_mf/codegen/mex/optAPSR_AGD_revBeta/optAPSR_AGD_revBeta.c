...
#include "projectT.h"
#include "expmapPSR.h"
#include "_coder_optAPSR_AGD_revBeta_api.h"
#include "objPSR.h"
#include "optAPSR_AGD_revBeta_mexutil.h"
#include "optAPSR_AGD_revBeta_data.h"

/* Variable Definitions */
static emlrtRSInfo emlrtRSI = { 38, "optAPSR_AGD_revBeta",
  "/cise/research51/cvgmi_04/jsun/DictLearningRecon/TMI_expts_SR/PSR_mf/optAPSR_AGD_revBeta.m"
};

static emlrtRSInfo b_emlrtRSI = { 42, "optAPSR_AGD_revBeta",
  "/cise/research51/cvgmi_04/jsun/DictLearningRecon/TMI_expts_SR/PSR_mf/optAPSR_AGD_revBeta.m"
};

static emlrtRSInfo c_emlrtRSI = { 44, "optAPSR_AGD_revBeta",
  "/cise/research51/cvgmi_04/jsun/DictLearningRecon/TMI_expts_SR/PSR_mf/optAPSR_AGD_revBeta.m"
};

static emlrtRSInfo d_emlrtRSI = { 51, "optAPSR_AGD_revBeta",
  "/cise/research51/cvgmi_04/jsun/DictLearningRecon/TMI_expts_SR/PSR_mf/optAPSR_AGD_revBeta.m"
};

static emlrtRSInfo e_emlrtRSI = { 52, "optAPSR_AGD_revBeta",
  "/cise/research51/cvgmi_04/jsun/DictLearningRecon/TMI_expts_SR/PSR_mf/optAPSR_AGD_revBeta.m"
};

static emlrtRSInfo f_emlrtRSI = { 53, "optAPSR_AGD_revBeta",
  "/cise/research51/cvgmi_04/jsun/DictLearningRecon/TMI_expts_SR/PSR_mf/optAPSR_AGD_revBeta.m"
};

static emlrtRSInfo g_emlrtRSI = { 55, "optAPSR_AGD_revBeta",
  "/cise/research51/cvgmi_04/jsun/DictLearningRecon/TMI_expts_SR/PSR_mf/optAPSR_AGD_revBeta.m"
};
...
static emlrtMCInfo emlrtMCI = { 64, 9, "optAPSR_AGD_revBeta",
  "/cise/research51/cvgmi_04/jsun/DictLearningRecon/TMI_expts_SR/PSR_mf/optAPSR_AGD_revBeta.m"
};

static emlrtMCInfo b_emlrtMCI = { 66, 9, "optAPSR_AGD_revBeta",
  "/cise/research51/cvgmi_04/jsun/DictLearningRecon/TMI_expts_SR/PSR_mf/optAPSR_AGD_revBeta.m"
};

static emlrtMCInfo c_emlrtMCI = { 77, 1, "optAPSR_AGD_revBeta",
  "/cise/research51/cvgmi_04/jsun/DictLearningRecon/TMI_expts_SR/PSR_mf/optAPSR_AGD_revBeta.m"
};

static emlrtRTEInfo l_emlrtRTEI = { 1, 32, "optAPSR_AGD_revBeta",
  "/cise/research51/cvgmi_04/jsun/DictLearningRecon/TMI_expts_SR/PSR_mf/optAPSR_AGD_revBeta.m"
};
...
static emlrtRTEInfo wb_emlrtRTEI = { 17, 1, "optAPSR_AGD_revBeta",
  "/cise/research51/cvgmi_04/jsun/DictLearningRecon/TMI_expts_SR/PSR_mf/optAPSR_AGD_revBeta.m"
};

static emlrtRTEInfo xb_emlrtRTEI = { 18, 1, "optAPSR_AGD_revBeta",
  "/cise/research51/cvgmi_04/jsun/DictLearningRecon/TMI_expts_SR/PSR_mf/optAPSR_AGD_revBeta.m"
};

static emlrtRTEInfo yb_emlrtRTEI = { 42, 5, "optAPSR_AGD_revBeta",
  "/cise/research51/cvgmi_04/jsun/DictLearningRecon/TMI_expts_SR/PSR_mf/optAPSR_AGD_revBeta.m"
};

static emlrtRTEInfo ac_emlrtRTEI = { 44, 5, "optAPSR_AGD_revBeta",
  "/cise/research51/cvgmi_04/jsun/DictLearningRecon/TMI_expts_SR/PSR_mf/optAPSR_AGD_revBeta.m"
};

static emlrtRTEInfo bc_emlrtRTEI = { 49, 5, "optAPSR_AGD_revBeta",
  "/cise/research51/cvgmi_04/jsun/DictLearningRecon/TMI_expts_SR/PSR_mf/optAPSR_AGD_revBeta.m"
};
...
static emlrtECInfo p_emlrtECI = { -1, 53, 9, "optAPSR_AGD_revBeta",
  "/cise/research51/cvgmi_04/jsun/DictLearningRecon/TMI_expts_SR/PSR_mf/optAPSR_AGD_revBeta.m"
};

static emlrtBCInfo mb_emlrtBCI = { -1, -1, 53, 15, "A", "optAPSR_AGD_revBeta",
  "/cise/research51/cvgmi_04/jsun/DictLearningRecon/TMI_expts_SR/PSR_mf/optAPSR_AGD_revBeta.m",
  0 };

static emlrtBCInfo nb_emlrtBCI = { -1, -1, 53, 51, "V", "optAPSR_AGD_revBeta",
  "/cise/research51/cvgmi_04/jsun/DictLearningRecon/TMI_expts_SR/PSR_mf/optAPSR_AGD_revBeta.m",
  0 };

static emlrtECInfo q_emlrtECI = { -1, 52, 9, "optAPSR_AGD_revBeta",
  "/cise/research51/cvgmi_04/jsun/DictLearningRecon/TMI_expts_SR/PSR_mf/optAPSR_AGD_revBeta.m"
};

static emlrtBCInfo ob_emlrtBCI = { -1, -1, 52, 15, "V", "optAPSR_AGD_revBeta",
  "/cise/research51/cvgmi_04/jsun/DictLearningRecon/TMI_expts_SR/PSR_mf/optAPSR_AGD_revBeta.m",
  0 };

static emlrtBCInfo pb_emlrtBCI = { -1, -1, 53, 36, "B", "optAPSR_AGD_revBeta",
  "/cise/research51/cvgmi_04/jsun/DictLearningRecon/TMI_expts_SR/PSR_mf/optAPSR_AGD_revBeta.m",
  0 };

static emlrtBCInfo qb_emlrtBCI = { -1, -1, 52, 46, "B0", "optAPSR_AGD_revBeta",
  "/cise/research51/cvgmi_04/jsun/DictLearningRecon/TMI_expts_SR/PSR_mf/optAPSR_AGD_revBeta.m",
  0 };

static emlrtBCInfo rb_emlrtBCI = { -1, -1, 52, 36, "B", "optAPSR_AGD_revBeta",
  "/cise/research51/cvgmi_04/jsun/DictLearningRecon/TMI_expts_SR/PSR_mf/optAPSR_AGD_revBeta.m",
  0 };

static emlrtECInfo r_emlrtECI = { -1, 51, 9, "optAPSR_AGD_revBeta",
  "/cise/research51/cvgmi_04/jsun/DictLearningRecon/TMI_expts_SR/PSR_mf/optAPSR_AGD_revBeta.m"
};

static emlrtBCInfo sb_emlrtBCI = { -1, -1, 51, 15, "B", "optAPSR_AGD_revBeta",
  "/cise/research51/cvgmi_04/jsun/DictLearningRecon/TMI_expts_SR/PSR_mf/optAPSR_AGD_revBeta.m",
  0 };

static emlrtBCInfo tb_emlrtBCI = { -1, -1, 51, 55, "eta", "optAPSR_AGD_revBeta",
  "/cise/research51/cvgmi_04/jsun/DictLearningRecon/TMI_expts_SR/PSR_mf/optAPSR_AGD_revBeta.m",
  0 };

static emlrtBCInfo ub_emlrtBCI = { -1, -1, 51, 37, "A0", "optAPSR_AGD_revBeta",
  "/cise/research51/cvgmi_04/jsun/DictLearningRecon/TMI_expts_SR/PSR_mf/optAPSR_AGD_revBeta.m",
  0 };

static emlrtRSInfo ce_emlrtRSI = { 64, "optAPSR_AGD_revBeta",
  "/cise/research51/cvgmi_04/jsun/DictLearningRecon/TMI_expts_SR/PSR_mf/optAPSR_AGD_revBeta.m"
};

static emlrtRSInfo de_emlrtRSI = { 77, "optAPSR_AGD_revBeta",
  "/cise/research51/cvgmi_04/jsun/DictLearningRecon/TMI_expts_SR/PSR_mf/optAPSR_AGD_revBeta.m"
};

static emlrtRSInfo ee_emlrtRSI = { 66, "optAPSR_AGD_revBeta",
  "/cise/research51/cvgmi_04/jsun/DictLearningRecon/TMI_expts_SR/PSR_mf/optAPSR_AGD_revBeta.m"
};
...
void optAPSR_AGD_revBeta(const emlrtStack *sp, const emxArray_real_T *X, const
  emxArray_real_T *W, emxArray_real_T *A0, struct0_T *param, real_T obj_old,
  emxArray_real_T *A, real_T *obj_new)
{
  int32_T n;
  int32_T m;
  int32_T i20;
  ...
  const mxArray *e_y;
  static const int32_T iv58[2] = { 1, 42 };

  char_T cv52[42];
  static const char_T cv53[42] = { 'o', 'b', 'j', ' ', 'i', 'n', 'c', 'r', 'e',
    'a', 's', 'e', 'd', ',', ' ', 'r', 'e', 'v', 'e', 'r', 's', 'e', ' ', 'a',
    'n', 'd', ' ', 'i', 'n', 'c', 'r', 'e', 'a', 's', 'e', ' ', 'b', 'e', 't',
    'a', '\\', 'n' };
  ...
  char_T cv54[13];
  static const char_T cv55[13] = { 'e', 'p', 's', ' ', 'r', 'e', 'a', 'c', 'h',
    'e', 'd', '\\', 'n' };

  const mxArray *g_y;
  static const int32_T iv60[2] = { 1, 13 };

  static const char_T cv56[13] = { 'm', 'a', 'x', 'i', 't', 'e', 'r', ':', ' ',
    '%', 'd', '\\', 'n' };
  ...
  *obj_new = 2.0 * obj_old;
  ...
  while ((!exitg1) && (s < maxiterAGD)) {
    ...
    /*  compute gradient */
    st.site = &b_emlrtRSI;
    i20 = V->size[0] * V->size[1] * V->size[2];
    V->size[0] = X->size[0];
    V->size[1] = X->size[1];
    V->size[2] = X->size[2];
    emxEnsureCapacity(&st, (emxArray__common *)V, i20, (int32_T)sizeof(real_T),
                      &l_emlrtRTEI);
    loop_ub = X->size[0] * X->size[1] * X->size[2];
    for (i20 = 0; i20 < loop_ub; i20++) {
      V->data[i20] = X->data[i20];
    }

    i20 = b_W->size[0] * b_W->size[1];
    b_W->size[0] = W->size[0];
    b_W->size[1] = W->size[1];
    emxEnsureCapacity(&st, (emxArray__common *)b_W, i20, (int32_T)sizeof(real_T),
                      &l_emlrtRTEI);
    ...
    i20 = AA->size[0] * AA->size[1] * AA->size[2];
    AA->size[0] = A0->size[0];
    AA->size[1] = A0->size[1];
    AA->size[2] = A0->size[2];
    emxEnsureCapacity(&st, (emxArray__common *)AA, i20, (int32_T)sizeof(real_T),
                      &l_emlrtRTEI);
    loop_ub = A0->size[0] * A0->size[1] * A0->size[2];
    for (i20 = 0; i20 < loop_ub; i20++) {
      AA->data[i20] = A0->data[i20];
    }
    ...
    i20 = gradA->size[0] * gradA->size[1] * gradA->size[2];
    gradA->size[0] = (int32_T)uv2[0];
    emxEnsureCapacity(&st, (emxArray__common *)gradA, i20, (int32_T)sizeof
                      (real_T), &l_emlrtRTEI);
    i20 = gradA->size[0] * gradA->size[1] * gradA->size[2];
...
#pragma omp parallel \
 ...
 private(r17,r16,r15,b_V,b_AA,b_A,d_X,b_loop_ub,c_loop_ub,i21,i22,i23,unnamed_idx_0,unnamed_idx_2,emlrtJBEnviron) \
...
#pragma omp for nowait
      ...
      for (i = 0; i <= ub_loop; i++) {
        ...
        if (setjmp(emlrtJBEnviron) == 0) {
          ...
          i21 = AA->size[1];
          i22 = 1 + i;
          i21 = emlrtDynamicBoundsCheckFastR2012b(i22, 1, i21, &lb_emlrtBCI,
            &b_st);
          i22 = b_AA->size[0] * b_AA->size[1] * b_AA->size[2];
          b_AA->size[0] = b_loop_ub;
          b_AA->size[1] = 1;
          b_AA->size[2] = c_loop_ub;
          emxEnsureCapacity(&b_st, (emxArray__common *)b_AA, i22, (int32_T)
                            sizeof(real_T), &l_emlrtRTEI);
          for (i22 = 0; i22 < c_loop_ub; i22++) {
            for (i23 = 0; i23 < b_loop_ub; i23++) {
              b_AA->data[i23 + b_AA->size[0] * b_AA->size[1] * i22] = AA->data
                [(i23 + AA->size[0] * (i21 - 1)) + AA->size[0] * AA->size[1] *
                i22];
            }
          }
          ...
          i21 = V->size[1];
          i22 = 1 + i;
          i21 = emlrtDynamicBoundsCheckFastR2012b(i22, 1, i21, &kb_emlrtBCI,
            &b_st);
          i22 = b_V->size[0] * b_V->size[1] * b_V->size[2];
          b_V->size[0] = b_loop_ub;
          b_V->size[1] = 1;
          b_V->size[2] = c_loop_ub;
          emxEnsureCapacity(&b_st, (emxArray__common *)b_V, i22, (int32_T)sizeof
                            (real_T), &l_emlrtRTEI);
          for (i22 = 0; i22 < c_loop_ub; i22++) {
            for (i23 = 0; i23 < b_loop_ub; i23++) {
              b_V->data[i23 + b_V->size[0] * b_V->size[1] * i22] = V->data[(i23
                + V->size[0] * (i21 - 1)) + V->size[0] * V->size[1] * i22];
            }
          }
          ...
          emxEnsureCapacity(&b_st, (emxArray__common *)r15, i21, (int32_T)sizeof
                            (int32_T), &l_emlrtRTEI);
          ...
          i21 = gradA->size[1];
          i22 = i + 1;
          emlrtDynamicBoundsCheckFastR2012b(i22, 1, i21, &jb_emlrtBCI, &b_st);
          b_loop_ub = gradA->size[2];
          i21 = r16->size[0];
          r16->size[0] = b_loop_ub;
          emxEnsureCapacity(&b_st, (emxArray__common *)r16, i21, (int32_T)sizeof
                            (int32_T), &l_emlrtRTEI);
          for (i21 = 0; i21 < b_loop_ub; i21++) {
            r16->data[i21] = i21;
          }
          ...
          for (i21 = 0; i21 < unnamed_idx_2; i21++) {
            for (i22 = 0; i22 < unnamed_idx_0; i22++) {
              gradA->data[(r15->data[i22] + gradA->size[0] * i) + gradA->size[0]
                * gradA->size[1] * r16->data[i21]] = r17->data[i22 +
                unnamed_idx_0 * i21];
            }
          }
    ...
    uv2[1] = (uint32_T)A0->size[1];
    uv2[2] = (uint32_T)A0->size[2];
    i20 = eta->size[0] * eta->size[1] * eta->size[2];
    eta->size[0] = (int32_T)uv2[0];
    emxEnsureCapacity(&st, (emxArray__common *)eta, i20, (int32_T)sizeof(real_T),
                      &l_emlrtRTEI);
    i20 = eta->size[0] * eta->size[1] * eta->size[2];
...
#pragma omp parallel \
 num_threads(emlrtAllocRegionTLSs(st.tls, omp_in_parallel(), omp_get_max_threads(), omp_get_num_procs())) \
 private(r17,r16,r15,b_gradA,c_AA,b_A,G,b_loop_ub,c_loop_ub,i21,i22,i23,unnamed_idx_0,unnamed_idx_2,emlrtJBEnviron) \
...
#pragma omp for nowait
      ...
      for (i = 0; i <= ub_loop; i++) {
        ...
        if (setjmp(emlrtJBEnviron) == 0) {
          ...
          i21 = AA->size[1];
          i22 = 1 + i;
          i21 = emlrtDynamicBoundsCheckFastR2012b(i22, 1, i21, &ib_emlrtBCI,
            &c_st);
          i22 = c_AA->size[0] * c_AA->size[1] * c_AA->size[2];
          c_AA->size[0] = b_loop_ub;
          c_AA->size[1] = 1;
          c_AA->size[2] = c_loop_ub;
          emxEnsureCapacity(&c_st, (emxArray__common *)c_AA, i22, (int32_T)
                            sizeof(real_T), &l_emlrtRTEI);
          for (i22 = 0; i22 < c_loop_ub; i22++) {
            for (i23 = 0; i23 < b_loop_ub; i23++) {
              c_AA->data[i23 + c_AA->size[0] * c_AA->size[1] * i22] = AA->data
                [(i23 + AA->size[0] * (i21 - 1)) + AA->size[0] * AA->size[1] *
                i22];
            }
          }
          ...
          i21 = gradA->size[1];
          i22 = 1 + i;
          i21 = emlrtDynamicBoundsCheckFastR2012b(i22, 1, i21, &hb_emlrtBCI,
            &c_st);
          i22 = b_gradA->size[0] * b_gradA->size[1] * b_gradA->size[2];
          b_gradA->size[0] = b_loop_ub;
          b_gradA->size[1] = 1;
          b_gradA->size[2] = c_loop_ub;
          emxEnsureCapacity(&c_st, (emxArray__common *)b_gradA, i22, (int32_T)
                            sizeof(real_T), &l_emlrtRTEI);
          for (i22 = 0; i22 < c_loop_ub; i22++) {
            for (i23 = 0; i23 < b_loop_ub; i23++) {
              b_gradA->data[i23 + b_gradA->size[0] * b_gradA->size[1] * i22] =
                gradA->data[(i23 + gradA->size[0] * (i21 - 1)) + gradA->size[0] *
                gradA->size[1] * i22];
            }
          }
          ...
          i21 = r15->size[0];
          r15->size[0] = b_loop_ub;
          emxEnsureCapacity(&c_st, (emxArray__common *)r15, i21, (int32_T)sizeof
                            (int32_T), &l_emlrtRTEI);
          for (i21 = 0; i21 < b_loop_ub; i21++) {
            r15->data[i21] = i21;
          }
          ...
          i21 = eta->size[1];
          i22 = i + 1;
          emlrtDynamicBoundsCheckFastR2012b(i22, 1, i21, &gb_emlrtBCI, &c_st);
          b_loop_ub = eta->size[2];
          i21 = r16->size[0];
          r16->size[0] = b_loop_ub;
          emxEnsureCapacity(&c_st, (emxArray__common *)r16, i21, (int32_T)sizeof
                            (int32_T), &l_emlrtRTEI);
          for (i21 = 0; i21 < b_loop_ub; i21++) {
            r16->data[i21] = i21;
          }
          ...
          for (i21 = 0; i21 < unnamed_idx_2; i21++) {
            for (i22 = 0; i22 < unnamed_idx_0; i22++) {
              eta->data[(r15->data[i22] + eta->size[0] * i) + eta->size[0] *
                eta->size[1] * r16->data[i21]] = r17->data[i22 + unnamed_idx_0 *
                i21];
            }
          }
    ...
    i20 = eta->size[0] * eta->size[1] * eta->size[2];
    emxEnsureCapacity(sp, (emxArray__common *)eta, i20, (int32_T)sizeof(real_T),
                      &l_emlrtRTEI);
    b_i = eta->size[0];
    ub_loop = eta->size[1];
    loop_ub = eta->size[2];
    loop_ub *= b_i * ub_loop;
    for (i20 = 0; i20 < loop_ub; i20++) {
      eta->data[i20] = -eta->data[i20];
    }

    /*  update the dictionary atoms */
    for (i20 = 0; i20 < 3; i20++) {
      uv2[i20] = (uint32_T)B->size[i20];
    }

    i20 = V->size[0] * V->size[1] * V->size[2];
    V->size[0] = (int32_T)uv2[0];
    emxEnsureCapacity(sp, (emxArray__common *)V, i20, (int32_T)sizeof(real_T),
                      &l_emlrtRTEI);
    i20 = V->size[0] * V->size[1] * V->size[2];
    ...
    while (c_i <= m - 1) {
      ...
      i20 = r14->size[0];
      r14->size[0] = loop_ub;
      emxEnsureCapacity(sp, (emxArray__common *)r14, i20, (int32_T)sizeof
                        (int32_T), &l_emlrtRTEI);
      for (i20 = 0; i20 < loop_ub; i20++) {
        r14->data[i20] = i20;
      }
      ...
      i20 = B->size[2];
      b_i = c_i + 1;
      emlrtDynamicBoundsCheckFastR2012b(b_i, 1, i20, &sb_emlrtBCI, sp);
      i20 = A0->size[2];
      b_i = c_i + 1;
      emlrtDynamicBoundsCheckFastR2012b(b_i, 1, i20, &ub_emlrtBCI, sp);
      normu = 1.0 / beta;
      i20 = eta->size[2];
      b_i = c_i + 1;
      emlrtDynamicBoundsCheckFastR2012b(b_i, 1, i20, &tb_emlrtBCI, sp);
      loop_ub = A0->size[0];
      ub_loop = A0->size[1];
      i20 = b_A0->size[0] * b_A0->size[1];
      b_A0->size[0] = loop_ub;
      b_A0->size[1] = ub_loop;
      emxEnsureCapacity(sp, (emxArray__common *)b_A0, i20, (int32_T)sizeof
                        (real_T), &l_emlrtRTEI);
      for (i20 = 0; i20 < ub_loop; i20++) {
        for (b_i = 0; b_i < loop_ub; b_i++) {
          b_A0->data[b_i + b_A0->size[0] * i20] = A0->data[(b_i + A0->size[0] *
            i20) + A0->size[0] * A0->size[1] * c_i];
        }
      }
      ...
      for (i20 = 0; i20 < ub_loop; i20++) {
        for (b_i = 0; b_i < loop_ub; b_i++) {
          b_y->data[b_i + b_y->size[0] * i20] = normu * eta->data[(b_i +
            eta->size[0] * i20) + eta->size[0] * eta->size[1] * c_i];
        }
      }
      ...
      for (i20 = 0; i20 < loop_ub; i20++) {
        ...
        for (b_i = 0; b_i < ub_loop; b_i++) {
          B->data[(r13->data[b_i] + B->size[0] * r14->data[i20]) + B->size[0] *
            B->size[1] * c_i] = b_W->data[b_i + b_W->size[0] * i20];
        }
      }
      ...
      i20 = V->size[2];
      b_i = c_i + 1;
      emlrtDynamicBoundsCheckFastR2012b(b_i, 1, i20, &ob_emlrtBCI, sp);
      st.site = &e_emlrtRSI;
      loop_ub = B->size[0];
      ub_loop = B->size[1];
      i20 = B->size[2];
      b_i = 1 + c_i;
      i20 = emlrtDynamicBoundsCheckFastR2012b(b_i, 1, i20, &rb_emlrtBCI, &st);
      ...
      for (b_i = 0; b_i < ub_loop; b_i++) {
        for (i24 = 0; i24 < loop_ub; i24++) {
          b_X->data[i24 + b_X->size[0] * b_i] = B->data[(i24 + B->size[0] * b_i)
            + B->size[0] * B->size[1] * (i20 - 1)];
        }
      }
      ...
      i20 = B0->size[2];
      b_i = 1 + c_i;
      i20 = emlrtDynamicBoundsCheckFastR2012b(b_i, 1, i20, &qb_emlrtBCI, &st);
      ...
      for (b_i = 0; b_i < ub_loop; b_i++) {
        for (i24 = 0; i24 < loop_ub; i24++) {
          Y->data[i24 + Y->size[0] * b_i] = B0->data[(i24 + B0->size[0] * b_i) +
            B0->size[0] * B0->size[1] * (i20 - 1)];
        }
      }
      ...
      loop_ub = B->size[0];
      ub_loop = B->size[1];
      i20 = c_B->size[0] * c_B->size[1];
      c_B->size[0] = loop_ub;
      c_B->size[1] = ub_loop;
      emxEnsureCapacity(&st, (emxArray__common *)c_B, i20, (int32_T)sizeof
                        (real_T), &l_emlrtRTEI);
      for (i20 = 0; i20 < ub_loop; i20++) {
        for (b_i = 0; b_i < loop_ub; b_i++) {
          c_B->data[b_i + c_B->size[0] * i20] = B->data[(b_i + B->size[0] * i20)
            + B->size[0] * B->size[1] * c_i];
        }
      }

      for (i20 = 0; i20 < 2; i20++) {
        uv3[i20] = (uint32_T)c_B->size[i20];
      }

      i20 = b_W->size[0] * b_W->size[1];
      b_W->size[0] = (int32_T)uv3[0];
      emxEnsureCapacity(&st, (emxArray__common *)b_W, i20, (int32_T)sizeof
                        (real_T), &l_emlrtRTEI);
      i20 = b_W->size[0] * b_W->size[1];
      ...
      while (ub_loop <= i20 - 1) {
        ...
        b_i = B->size[1];
        i24 = 1 + ub_loop;
        emlrtDynamicBoundsCheckFastR2012b(i24, 1, b_i, &fb_emlrtBCI, &st);
        b_i = c_X->size[0];
        c_X->size[0] = loop_ub;
        ...
        b_i = B0->size[1];
        i24 = 1 + ub_loop;
        emlrtDynamicBoundsCheckFastR2012b(i24, 1, b_i, &eb_emlrtBCI, &st);
        b_i = b_Y->size[0];
        b_Y->size[0] = loop_ub;
        ...
        if (!(a->size[1] == y->size[0])) {
          if ((a->size[1] == 1) || (y->size[0] == 1)) {
            ...
            error(&f_st, b_message(&g_st, c_y, &f_emlrtMCI), &g_emlrtMCI);
          } else {
            ...
            error(&f_st, b_message(&g_st, d_y, &h_emlrtMCI), &i_emlrtMCI);
          }
        }
        ...
        b_i = y->size[0];
        i24 = x->size[0];
        emlrtSizeEqCheck1DFastR2012b(b_i, i24, &m_emlrtECI, &st);
        b_i = y->size[0];
        ...
        b_i = b_W->size[1];
        i24 = ub_loop + 1;
        emlrtDynamicBoundsCheckFastR2012b(i24, 1, b_i, &db_emlrtBCI, &st);
        iv55[0] = r18->size[0];
      ...
      for (i20 = 0; i20 < loop_ub; i20++) {
        ub_loop = b_W->size[0];
        for (b_i = 0; b_i < ub_loop; b_i++) {
          V->data[(r13->data[b_i] + V->size[0] * r14->data[i20]) + V->size[0] *
            V->size[1] * c_i] = b_W->data[b_i + b_W->size[0] * i20];
        }
      }
      ...
      i20 = A->size[2];
      b_i = c_i + 1;
      emlrtDynamicBoundsCheckFastR2012b(b_i, 1, i20, &mb_emlrtBCI, sp);
      i20 = B->size[2];
      b_i = c_i + 1;
      emlrtDynamicBoundsCheckFastR2012b(b_i, 1, i20, &pb_emlrtBCI, sp);
      i20 = V->size[2];
      b_i = c_i + 1;
      emlrtDynamicBoundsCheckFastR2012b(b_i, 1, i20, &nb_emlrtBCI, sp);
      loop_ub = B->size[0];
      ub_loop = B->size[1];
      i20 = b_B->size[0] * b_B->size[1];
      b_B->size[0] = loop_ub;
      b_B->size[1] = ub_loop;
      emxEnsureCapacity(sp, (emxArray__common *)b_B, i20, (int32_T)sizeof(real_T),
                        &l_emlrtRTEI);
      for (i20 = 0; i20 < ub_loop; i20++) {
        for (b_i = 0; b_i < loop_ub; b_i++) {
          b_B->data[b_i + b_B->size[0] * i20] = B->data[(b_i + B->size[0] * i20)
            + B->size[0] * B->size[1] * c_i];
        }
      }
      ...
      loop_ub = V->size[0];
      ub_loop = V->size[1];
      i20 = b_gamma->size[0] * b_gamma->size[1];
      b_gamma->size[0] = loop_ub;
      b_gamma->size[1] = ub_loop;
      emxEnsureCapacity(sp, (emxArray__common *)b_gamma, i20, (int32_T)sizeof
                        (real_T), &l_emlrtRTEI);
      for (i20 = 0; i20 < ub_loop; i20++) {
        for (b_i = 0; b_i < loop_ub; b_i++) {
          b_gamma->data[b_i + b_gamma->size[0] * i20] = c_gamma * V->data[(b_i +
            V->size[0] * i20) + V->size[0] * V->size[1] * c_i];
        }
      }
      ...
      for (i20 = 0; i20 < loop_ub; i20++) {
        ub_loop = b_W->size[0];
        for (b_i = 0; b_i < ub_loop; b_i++) {
          A->data[(r13->data[b_i] + A->size[0] * r14->data[i20]) + A->size[0] *
            A->size[1] * c_i] = b_W->data[b_i + b_W->size[0] * i20];
        }
      }
    ...
    *obj_new = objPSR(&st, X, W, A);
    guard1 = false;
    if (obj_old < *obj_new) {
      /*  if obj increases, reverse and increase beta */
      beta *= 2.0;
      i20 = A->size[0] * A->size[1] * A->size[2];
      A->size[0] = A0->size[0];
      A->size[1] = A0->size[1];
      ...
      emxEnsureCapacity(sp, (emxArray__common *)B, i20, (int32_T)sizeof(real_T),
                        &l_emlrtRTEI);
      loop_ub = B0->size[0] * B0->size[1] * B0->size[2];
      for (i20 = 0; i20 < loop_ub; i20++) {
        B->data[i20] = B0->data[i20];
      }
      ...
      *obj_new = obj_old;
      ...
      for (c_i = 0; c_i < 42; c_i++) {
        cv52[c_i] = cv53[c_i];
      }

      emlrtInitCharArrayR2013a(sp, 42, m17, cv52);
      emlrtAssign(&e_y, m17);
      st.site = &ce_emlrtRSI;
      b_fprintf(&st, emlrt_marshallOut(1.0), e_y, &emlrtMCI);
      guard1 = true;
    } else if ((obj_old - *obj_new) / (real_T)n < epsAGD) {
      f_y = NULL;
      ...
      emlrtInitCharArrayR2013a(sp, 13, m17, cv54);
      emlrtAssign(&f_y, m17);
      st.site = &ee_emlrtRSI;
      b_fprintf(&st, emlrt_marshallOut(1.0), f_y, &b_emlrtMCI);
      exitg1 = true;
    } else {
      guard1 = true;
    }
    ...
    if (guard1) {
      i20 = A0->size[0] * A0->size[1] * A0->size[2];
      A0->size[0] = A->size[0];
      A0->size[1] = A->size[1];
      A0->size[2] = A->size[2];
      emxEnsureCapacity(sp, (emxArray__common *)A0, i20, (int32_T)sizeof(real_T),
                        &l_emlrtRTEI);
      loop_ub = A->size[0] * A->size[1] * A->size[2];
      for (i20 = 0; i20 < loop_ub; i20++) {
        A0->data[i20] = A->data[i20];
      }
  ...
  param->beta = beta;
  g_y = NULL;
  m17 = emlrtCreateCharArray(2, iv60);
  for (c_i = 0; c_i < 13; c_i++) {
    cv54[c_i] = cv56[c_i];
  }
  ...
  emlrtAssign(&g_y, m17);
  st.site = &de_emlrtRSI;
  b_fprintf(&st, g_y, emlrt_marshallOut(s), &c_emlrtMCI);
  emlrtHeapReferenceStackLeaveFcnR2012b(sp);
}

/* End of code generation (optAPSR_AGD_revBeta.c) */
