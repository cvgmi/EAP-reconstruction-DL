/*
 * costMatrixPSR_emxutil.h
 *
 * Code generation for function 'costMatrixPSR_emxutil'
 *
 */

#ifndef __COSTMATRIXPSR_EMXUTIL_H__
#define __COSTMATRIXPSR_EMXUTIL_H__
...
/* End of code generation (costMatrixPSR_emxutil.h) */
