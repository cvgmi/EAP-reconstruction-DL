...
static emlrtRTEInfo p_emlrtRTEI = { 1, 15, "logmapPSRi",
  "/blank0/blank0/DictL_ProductSpace/Discrete/SRProductSpace/mf/logmapPSRi.m" };

static emlrtRTEInfo q_emlrtRTEI = { 21, 5, "squeeze",
  "/opt/matlab2014b/toolbox/eml/lib/matlab/elmat/squeeze.m" };

static emlrtRTEInfo r_emlrtRTEI = { 51, 1, "squeeze",
  "/opt/matlab2014b/toolbox/eml/lib/matlab/elmat/squeeze.m" };

static emlrtRTEInfo s_emlrtRTEI = { 16, 5, "logmapPSRi",
  "/blank0/blank0/DictL_ProductSpace/Discrete/SRProductSpace/mf/logmapPSRi.m" };

static emlrtRTEInfo t_emlrtRTEI = { 15, 5, "logmapPSRi",
  "/blank0/blank0/DictL_ProductSpace/Discrete/SRProductSpace/mf/logmapPSRi.m" };

static emlrtBCInfo c_emlrtBCI = { -1, -1, 15, 21, "X", "logmapPSRi",
  "/blank0/blank0/DictL_ProductSpace/Discrete/SRProductSpace/mf/logmapPSRi.m", 0
};

static emlrtBCInfo d_emlrtBCI = { -1, -1, 16, 22, "YY", "logmapPSRi",
  "/blank0/blank0/DictL_ProductSpace/Discrete/SRProductSpace/mf/logmapPSRi.m", 0
};

static emlrtBCInfo e_emlrtBCI = { -1, -1, 17, 10, "VV", "logmapPSRi",
  "/blank0/blank0/DictL_ProductSpace/Discrete/SRProductSpace/mf/logmapPSRi.m", 0
};

static emlrtECInfo emlrtECI = { -1, 17, 5, "logmapPSRi",
  "/blank0/blank0/DictL_ProductSpace/Discrete/SRProductSpace/mf/logmapPSRi.m" };
...
#pragma omp parallel \
 ...
 private(r1,r2,r3,x,Y,i3,i4,b,overflow,k,exitg1,b1,b_loop_ub,unnamed_idx_0,unnamed_idx_2,j,b2,emlrtJBEnviron) \
 firstprivate(st,b_st,c_st,d_st,iv7,emlrtHadParallelError,sqsz)

  {
    if (setjmp(emlrtJBEnviron) == 0) {
      ...
      d_st.prev = &c_st;
      d_st.tls = c_st.tls;
      emxInit_real_T(&st, &r1, 2, &p_emlrtRTEI, true);
      emxInit_int32_T(&st, &r2, 1, &p_emlrtRTEI, true);
      emxInit_int32_T(&st, &r3, 1, &p_emlrtRTEI, true);
      c_emxInit_real_T(&st, &x, 1, &t_emlrtRTEI, true);
...
#pragma omp for nowait
    ...
    for (i = 0; i <= ub_loop; i++) {
      ...
      if (setjmp(emlrtJBEnviron) == 0) {
        ...
        i3 = X->size[1];
        i4 = i + 1;
        emlrtDynamicBoundsCheckFastR2012b(i4, 1, i3, &c_emlrtBCI, &b_st);
        i3 = X->size[0];
        i4 = x->size[0];
        x->size[0] = i3;
        ...
        i3 = YY->size[1];
        i4 = i + 1;
        emlrtDynamicBoundsCheckFastR2012b(i4, 1, i3, &d_emlrtBCI, &b_st);
        k = 3;
        exitg1 = false;
        while ((!exitg1) && (k > 2)) {
          i3 = YY->size[2];
        ...
        i3 = r3->size[0];
        r3->size[0] = b_loop_ub;
        emxEnsureCapacity(&st, (emxArray__common *)r3, i3, (int32_T)sizeof
                          (int32_T), &p_emlrtRTEI);
        ...
        i3 = r2->size[0];
        r2->size[0] = b_loop_ub;
        emxEnsureCapacity(&st, (emxArray__common *)r2, i3, (int32_T)sizeof
                          (int32_T), &p_emlrtRTEI);
        for (i3 = 0; i3 < b_loop_ub; i3++) {
          r2->data[i3] = i3;
        }
        ...
        logmapSRi(&b_st, x, Y, r1);
        iv7[0] = r3->size[0];
        iv7[1] = 1;
        iv7[2] = r2->size[0];
        emlrtSubAssignSizeCheckR2012b(iv7, 3, *(int32_T (*)[2])r1->size, 2,
          &emlrtECI, &st);
        unnamed_idx_0 = r3->size[0];
        unnamed_idx_2 = r2->size[0];
        for (i3 = 0; i3 < unnamed_idx_2; i3++) {
          for (i4 = 0; i4 < unnamed_idx_0; i4++) {
            VV->data[(r3->data[i4] + VV->size[0] * i) + VV->size[0] * VV->size[1]
              * r2->data[i3]] = r1->data[i4 + unnamed_idx_0 * i3];
          }
        }
