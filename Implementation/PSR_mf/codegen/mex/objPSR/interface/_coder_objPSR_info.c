...
const mxArray *emlrtMexFcnResolvedFunctionsInfo(void)
{
  ...
  emlrtAssign(&nameCaptureInfo, emlrtCreateStructMatrix(153, 1, 0, NULL));
...
static void c_info_helper(const mxArray **info)
{
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[E]/blank0/blank0/DictL_ProductSpace/Discrete/SRProductSpace/mf/objPSR.m"),
                "context", 150);
  emlrtAddField(*info, emlrt_marshallOut("trace"), "name", 150);
  emlrtAddField(*info, emlrt_marshallOut("double"), "dominantType", 150);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/matfun/trace.m"), "resolved", 150);
  emlrtAddField(*info, b_emlrt_marshallOut(1363731868U), "fileTimeLo", 150);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/matfun/trace.m"), "context", 151);
  emlrtAddField(*info, emlrt_marshallOut("coder.internal.isBuiltInNumeric"),
                "name", 151);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/shared/coder/coder/+coder/+internal/isBuiltInNumeric.m"),
                "resolved", 151);
  emlrtAddField(*info, b_emlrt_marshallOut(1395949856U), "fileTimeLo", 151);
...
mxArray *emlrtMexFcnProperties()
{
  ...
  mxSetFieldByNumber(xEntryPoints, 0, 0, mxCreateString("objPSR"));
...
/* End of code generation (_coder_objPSR_info.c) */
