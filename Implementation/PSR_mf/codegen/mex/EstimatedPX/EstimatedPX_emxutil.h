/*
 * EstimatedPX_emxutil.h
 *
 * Code generation for function 'EstimatedPX_emxutil'
 *
 */

#ifndef __ESTIMATEDPX_EMXUTIL_H__
#define __ESTIMATEDPX_EMXUTIL_H__
...
/* End of code generation (EstimatedPX_emxutil.h) */
