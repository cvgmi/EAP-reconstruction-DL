...
static emlrtRSInfo xb_emlrtRSI = { 13, "rdivide",
  "/opt/matlab2014b/toolbox/eml/lib/matlab/ops/rdivide.m" };

static emlrtRSInfo hc_emlrtRSI = { 14, "rdivide",
  "/opt/matlab2014b/toolbox/eml/lib/matlab/ops/rdivide.m" };
             ...
             emxArray_real_T *y, emxArray_real_T *z)
{
  ...
  const mxArray *m6;
  char_T cv24[15];
  static const char_T cv25[15] = { 'M', 'A', 'T', 'L', 'A', 'B', ':', 'd', 'i',
    'm', 'a', 'g', 'r', 'e', 'e' };
  ...
  if (p) {
    ...
    emlrtInitCharArrayR2013a(sp, 15, m6, cv24);
    emlrtAssign(&b_y, m6);
    st.site = &xb_emlrtRSI;
    b_st.site = &hc_emlrtRSI;
    error(&st, b_message(&b_st, b_y, &m_emlrtMCI), &n_emlrtMCI);
  }
