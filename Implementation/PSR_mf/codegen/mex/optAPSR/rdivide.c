...
static emlrtRTEInfo f_emlrtRTEI = { 14, 5, "rdivide",
...
static emlrtRTEInfo ob_emlrtRTEI = { 1, 14, "rdivide",
  "/opt/matlab2014b/toolbox/eml/lib/matlab/ops/rdivide.m" };

static emlrtRSInfo hd_emlrtRSI = { 13, "rdivide",
  "/opt/matlab2014b/toolbox/eml/lib/matlab/ops/rdivide.m" };

static emlrtRSInfo qd_emlrtRSI = { 14, "rdivide",
  "/opt/matlab2014b/toolbox/eml/lib/matlab/ops/rdivide.m" };
             ...
             emxArray_real_T *y, emxArray_real_T *z)
{
  ...
  const mxArray *m7;
  char_T cv33[15];
  static const char_T cv34[15] = { 'M', 'A', 'T', 'L', 'A', 'B', ':', 'd', 'i',
    'm', 'a', 'g', 'r', 'e', 'e' };
  ...
  if (p) {
    ...
    emlrtInitCharArrayR2013a(sp, 15, m7, cv33);
    emlrtAssign(&b_y, m7);
    st.site = &hd_emlrtRSI;
