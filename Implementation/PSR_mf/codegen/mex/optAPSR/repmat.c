...
static emlrtRSInfo cb_emlrtRSI = { 12, "repmat",
  "/opt/matlab2014b/toolbox/eml/lib/matlab/elmat/repmat.m" };

static emlrtRSInfo db_emlrtRSI = { 40, "repmat",
  "/opt/matlab2014b/toolbox/eml/lib/matlab/elmat/repmat.m" };

static emlrtRSInfo eb_emlrtRSI = { 47, "repmat",
  "/opt/matlab2014b/toolbox/eml/lib/matlab/elmat/repmat.m" };

static emlrtRSInfo ob_emlrtRSI = { 42, "repmat",
  "/opt/matlab2014b/toolbox/eml/lib/matlab/elmat/repmat.m" };

static emlrtRSInfo pb_emlrtRSI = { 45, "repmat",
  "/opt/matlab2014b/toolbox/eml/lib/matlab/elmat/repmat.m" };

static emlrtRTEInfo c_emlrtRTEI = { 24, 5, "repmat",
  "/opt/matlab2014b/toolbox/eml/lib/matlab/elmat/repmat.m" };

static emlrtMCInfo k_emlrtMCI = { 24, 5, "repmat",
  "/opt/matlab2014b/toolbox/eml/lib/matlab/elmat/repmat.m" };

static emlrtRTEInfo ib_emlrtRTEI = { 30, 1, "repmat",
  "/opt/matlab2014b/toolbox/eml/lib/matlab/elmat/repmat.m" };

static emlrtRSInfo id_emlrtRSI = { 24, "repmat",
  "/opt/matlab2014b/toolbox/eml/lib/matlab/elmat/repmat.m" };
              ...
              emxArray_real_T *b)
{
  ...
  char_T cv31[15];
  static const char_T cv32[15] = { 'M', 'A', 'T', 'L', 'A', 'B', ':', 'p', 'm',
    'a', 'x', 's', 'i', 'z', 'e' };
  ...
  if (b_varargin_1) {
    ...
    emlrtInitCharArrayR2013a(&st, 28, m6, cv27);
    emlrtAssign(&y, m6);
    b_y = NULL;
  ...
  if (2.147483647E+9 >= c_varargin_1) {
    ...
    emlrtInitCharArrayR2013a(&st, 21, m6, cv29);
    emlrtAssign(&d_y, m6);
  ...
  if (i == a->size[1]) {
    ...
    emlrtInitCharArrayR2013a(sp, 15, m6, cv31);
    emlrtAssign(&e_y, m6);
    st.site = &id_emlrtRSI;
            ...
            emxArray_real_T *b)
{
  ...
  char_T cv25[15];
  static const char_T cv26[15] = { 'M', 'A', 'T', 'L', 'A', 'B', ':', 'p', 'm',
    'a', 'x', 's', 'i', 'z', 'e' };
  ...
  if (b_varargin_2) {
    ...
    emlrtInitCharArrayR2013a(&st, 28, m4, cv23);
    emlrtAssign(&y, m4);
    b_y = NULL;
  ...
  if (i == a->size[0]) {
    ...
    emlrtInitCharArrayR2013a(sp, 15, m4, cv25);
    emlrtAssign(&d_y, m4);
    st.site = &id_emlrtRSI;
