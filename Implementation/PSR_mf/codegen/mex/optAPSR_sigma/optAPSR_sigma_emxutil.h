/*
 * optAPSR_sigma_emxutil.h
 *
 * Code generation for function 'optAPSR_sigma_emxutil'
 *
 */

#ifndef __OPTAPSR_SIGMA_EMXUTIL_H__
#define __OPTAPSR_SIGMA_EMXUTIL_H__
...
/* End of code generation (optAPSR_sigma_emxutil.h) */
