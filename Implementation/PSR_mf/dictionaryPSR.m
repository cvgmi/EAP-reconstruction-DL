function [objhist, W, A, AtomHist] = dictionaryPSR(X, param)
% Dictionary learning on the product manifold of Hilber unit sphere, where
% fields/patches of square root densities reside
% Input:
...
%    eps - stopping criterion on change of objective function value between
%          iterarions
%
% Output:
...
% using kmeans on Euclidean space then normalize
...
%     A = optAPSR_mex(X,W,A0,param);
    [A,obj] = optAPSR_sigma_mex(X,W,A0,paramASP,obj);
%     [A,obj] = optAPSR_AGD_mex(X,W,A0,param,obj);
